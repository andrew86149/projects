...
sf::Texture textureBranch("graphics/branch.png");
//textureBranch.loadFromFile("graphics/branch.png")
sf::Sprite branch1(textureBranch);
sf::Sprite branch2(textureBranch);
sf::Sprite branch3(textureBranch);
sf::Sprite branch4(textureBranch);
sf::Sprite branch5(textureBranch);
sf::Sprite branch6(textureBranch);
sf::Sprite branches[NUM_BRANCHES] = {branch1, branch2,branch3,branch4,branch5,branch6};
