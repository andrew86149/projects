...
,m_font("assets/font.ttf"),m_logo("assets/logo.png"),m_texture("assets/texture.png")
{
	...
	while (m_window.isOpen())
    {
		while (const std::optional event = m_window.pollEvent())
        {
            if (event->is<sf::Event::Closed>()) m_window.close();   
                     ...
                     {
						 if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::I)) m_currentState->insertCoin();
						 if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::S))  m_currentState->pressButton();
						 if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Left)) m_currentState->moveStick(sf::Vector2i(-1, 0));
						 if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Right)) m_currentState->moveStick(sf::Vector2i(1, 0));
						 if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Up)) m_currentState->moveStick(sf::Vector2i(0, -1));
						 if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Down)) m_currentState->moveStick(sf::Vector2i(0, 1));
